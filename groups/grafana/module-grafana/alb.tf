resource "aws_acm_certificate" "certificate" {
  ...
  domain_name               = "${var.service}-${var.environment}-grafana.${var.load_balancer_dns_zone_name}"
  subject_alternative_names = ["*.${var.service}-${var.environment}-grafana.${var.load_balancer_dns_zone_name}"]
